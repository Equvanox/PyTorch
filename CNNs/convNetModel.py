...
train = datasets.FashionMNIST(root=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData",
                              train=True,
                              transform=transforms.ToTensor(),
                              download=False)
test = datasets.FashionMNIST(root=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData",
                             train=False,
                             transform=transforms.ToTensor(),
                             download=False)
print(train, test)
...
torch.save(model_v3, r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\Saved_Models\CVConvNetModel.pt")
torch.save(model_v3.state_dict(), r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\Saved_Models\CVConvNetModel_state_dict.pt")