...
if __name__ == "__main__":
    ...
    trainPath_10, testPath_10 = data_gatherer(dataSource="https://github.com/mrdbourke/pytorch-deep-learning/raw/main/data/pizza_steak_sushi.zip",
                                            destination=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData\CustomFood101\Data_10_percent",
                                            delete_source=True)
    trainPath_20, testPath_20 = data_gatherer(dataSource="https://github.com/mrdbourke/pytorch-deep-learning/raw/main/data/pizza_steak_sushi_20_percent.zip",
                                            destination=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData\CustomFood101\Data_20_percent",
                                            delete_source=True)
    ...
    tb_writer = writer.SummaryWriter(log_dir=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\runs")  # this type of call will take log_dir parameter as default(/runs/<date>_<time>_<sysCode>) -> (/runs/Nov02_13-26-00_84bdaa7bbe56)
    def creating_tensorboard_writer(experiment_name: str,
                                    model_name: str,
                                    extra: str=None) -> torch.utils.tensorboard.writer:
        timestamp = datetime.now().strftime("%Y-%m-%d")
        log_dir = os.path.join(r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\runs",timestamp,experiment_name,model_name,extra) if extra else os.path.join(r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\runs",timestamp,experiment_name,model_name)
    ...
    for dataloader_name, dataloader in dataloaders.items():
        for model_name in models:
            for epoch in epoch_list:
                ...
                utils.saving_model(dirPath=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\Saved_Models\ExperimentTracking",
    ...
    best_model_path = r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\Saved_Models\ExperimentTracking\Model-train_20_dataloader-effnet_b2-10_epochs.pt"
    ...
    predictions.predict_a_image(path=r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData\CustomFood101\steak_from_internet.jpg",
                                model=best_model,
                                class_names=class_names,
                                image_size=(224,224))
