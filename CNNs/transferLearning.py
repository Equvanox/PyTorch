...
if __name__ == "__main__":     # necessary for running next(iter()) and enumerate()
    ...
    trainPath = Path(r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData\CustomFood101\Images\train")
    testPath = Path(r"D:\VisualStudioCode\Python\AI\DeepLearning\pyTorch\CNNs\SampleData\CustomFood101\Images\test")
